<%-- 
    Document   : index
    Created on : Oct 1, 2020, 1:24:41 PM
    Author     : juan
--%>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-3 center">
                    <span class="profile-picture">
                        <img class="editable img-responsive" alt=" Avatar" id="avatar2" src="${estudiante.getImagen()}">
                    </span>

                    <div class="space space-4"></div>

                    <a href="http://www.udea.edu.co/" class="btn btn-sm btn-block btn-success">
                        <i class="ace-icon fa fa-plus-circle bigger-120"></i>
                        <span class="bigger-110">Universidad de Antioquia</span>
                    </a>

                    <a href="#" class="btn btn-sm btn-block btn-primary">
                        <i class="ace-icon fa fa-envelope-o bigger-110"></i>
                        <span class="bigger-110">2020 - 1</span>
                    </a>
                </div><!-- /.col -->
                <div class="col-xs-12 col-sm-9">
                    <h4 class="blue">
                        <span class="middle">Estudiante</span>
                    ...
                    <div class="profile-user-info">
                        ...
                        <div class="profile-info-row">
                            ...
                            <div class="profile-info-value">
                                ...
                                <span>${estudiante.getNombre()}</span>
                            </div>
                        </div>
                        <div class="profile-info-row">
                            <div class="profile-info-name"> Correo electrónico </div>
                            <div class="profile-info-value">
                                <span>${estudiante.getCorreo()}</span>
                            </div>
                        </div>
                        <div class="profile-info-row">
                        </div>
                    ...
                    <div class="profile-user-info">
                        <div class="profile-info-row">
                            <div class="profile-info-name"> Materias </div>
                        </div>
                        <c:choose>
                            <c:when test="${param.banderita != 1}">
                            ...
                            <c:otherwise>
                                <div class="profile-info-row">
                                    ...
                                    <div class="profile-info-value">
                                        <a href="#">No hay materias matriculadas</a>
                                    </div>
                                </div>
                            </c:otherwise>
                        </c:choose>
